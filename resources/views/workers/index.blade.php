                    ...
                    <form action="" method="POST" class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input type="text" name="username" class="form-control text-center" placeholder="Login" value="{{ old('username') }}">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" name="name" class="form-control text-center" placeholder="Nom" value="{{ old('name') }}">
                                @if($errors->has('name'))
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" name="surname" class="form-control text-center" placeholder="Prenom" value="{{ old('surname') }}">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input type="tel" name="telephone" class="form-control text-center" placeholder="Téléphone" value="{{ old('telephone') }}">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="date" name="birthday" class="form-control text-center" placeholder="Date de naissance" value="{{ old('birthday') }}">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="email" name="email" class="form-control text-center" placeholder="Adresse e-mail" value="{{ old('email') }}">
                                @if($errors->has('email'))
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="genre" id="inlineCheckbox1" value="Male">
                                <label class="form-check-label" for="inlineCheckbox1">Homme</label>
                                </div>
                                <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="genre" value="Female">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" name="adresse" class="form-control text-center" placeholder="Adresse" value="{{ old('adresse') }}">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input type="password" name="pass" class="form-control text-center" placeholder="Mot de passe">
                                @if($errors->has('pass'))
