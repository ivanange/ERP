            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-success btn-sm" href="/payroll/paie/{{$worker->id}}/bulletin"> <i
                                class="fas fa-edit"></i></a>
                        <form action="/payroll/paie/{{$worker->id}}/pay" method="post">
                            <button type="submit" class="btn btn-dark" onclick="event.stopPropagation();">Pay</button>
                        </form>
                    </td>
                </tr>
                @endforeach
